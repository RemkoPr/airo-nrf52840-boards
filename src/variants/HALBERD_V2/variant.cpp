...
PinDescription g_APinDescription[] = {
  // D0 - D16
  { P0_6,  NULL, NULL, NULL },     // D0/SERVO1 | (0u)
  { P0_25, NULL, NULL, NULL },     // D1/SERVO2
  { P0_9, NULL, NULL, NULL },     // D2/SERVO3
  { P0_24, NULL, NULL, NULL },     // D3/SERVO4
  { P0_27, NULL, NULL, NULL },     // D4
  { P0_15, NULL, NULL, NULL },     // D5/SCL2
  { P0_14, NULL, NULL, NULL },     // D6/SDA2
  { P1_13, NULL, NULL, NULL },     // D7
  { P1_12, NULL, NULL, NULL },     // D8
  { P1_11, NULL, NULL, NULL },     // D9
  { P1_10,  NULL, NULL, NULL },     // D10
  { P1_3,  NULL, NULL, NULL },     // D11
  { P1_15,  NULL, NULL, NULL },     // D12/TX
  { P1_14, NULL, NULL, NULL },     // D13/RX
  { P0_11, NULL, NULL, NULL },     // D14/SCK
  { P1_9, NULL, NULL, NULL },     // D15/MOSI/SCL1
  { P1_8, NULL, NULL, NULL },     // D16/MISO/SDA1

  // A0 - A7
  { P0_5,  NULL, NULL, NULL },     // A0 | (17u)
  { P0_4,  NULL, NULL, NULL },     // A1
  { P0_30, NULL, NULL, NULL },     // A2
  { P0_29, NULL, NULL, NULL },     // A3
  { P0_31, NULL, NULL, NULL },     // A4
  { P0_2,  NULL, NULL, NULL },     // A5
  { P0_28, NULL, NULL, NULL },     // A6
  { P0_3,  NULL, NULL, NULL },     // A7
  
  // LED
  { P0_17, NULL, NULL, NULL },     // LED_R | (25u)
  { P0_20,  NULL, NULL, NULL },     // LED_G
  { P0_13,  NULL, NULL, NULL },     // LED_B
  
  // I2C enable
  { P0_7,  NULL, NULL, NULL },	   // enable external pull-ups on I2C1/Wire
  { P0_26,  NULL, NULL, NULL }	   // enable external pull-ups on I2C2/Wire1
};
...
void initVariant() {
  ...
  // I2C external pullups disabled by default
  pinMode(PIN_ENABLE_WIRE_PULLUP, OUTPUT);
  pinMode(PIN_ENABLE_WIRE1_PULLUP, OUTPUT);
  digitalWrite(PIN_ENABLE_WIRE_PULLUP, HIGH);
  digitalWrite(PIN_ENABLE_WIRE1_PULLUP, HIGH);
